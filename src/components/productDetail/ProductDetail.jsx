...
const ProductDetail = () => {
    ...
    PriceRadioBtnArry.map((obj, index) => (
      <RadioBox
        ...
        onOptionChange={(event) =>
          setFormFields({ ...formFields, giftPrice: event.target.value })
        }
  ...
  const SendNowOrLaterRadioBtns = () =>
    sendNowOrLaterBtnArr.map((obj, index) => (
      <RadioBox
        key={index}
        onOptionChange={(event) =>
          setFormFields({ ...formFields, sendLatterOrNow: event.target.value })
        }
  ...
  const GiftCategoryBtn = giftCategoryArr.map((ele) => (
    <SwiperSlide>
      <RadioBox
        ...
        <div className={""}>
          <div className="row">
            <div className="col-md-6 col-lg-4">
              ...
              <Redeemable />
              <div className="offersCmpContainer">
                <Offers />
              </div>
            </div>
                ...
                <>
                  ...
                  <div className="radiobtn-group ">
                    <ImageCarouselRadioBtn
                      onChange={(index) =>
                        setFormFields({ ...formFields, giftCardTheme: index })
                      }
